...
val_size = 0.10  # 10% of total data (you can adjust this)
...
best_epoch = train_binary(model, train_loader, val_loader, optimizer, criterion, epochs=numepochs, save_path=save_path)
